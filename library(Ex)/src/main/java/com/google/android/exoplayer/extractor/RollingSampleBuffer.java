...
//    File mFiel = new File(Environment.getExternalStorageDirectory(), "logs.mp4" +
//            "");
//
...
//            Allocation allocation1 = dataQueue.peek();
//            fos.write(allocation1.data);
            ...
            while (remaining > 0) {
                ...
                srcOffset = allocation.translateOffset(positionInAllocation);
//
//                Log.e("readdata l-287 file RSB", allocation.data.toString());
//
//                for (int i = srcOffset; i < srcOffset + toCopy; ++i) {
//                    fos.write(allocation.data[i]);
//                }

                target.put(allocation.data, srcOffset, toCopy);
...
//                Log.e("readdata l-287 file RSB", allocation.data.toString());
                ...
                /**
                 * Code used to save data using conditions as used by further in this
                 * application .
                 */
...
//                FileOutputStream fos = new FileOutputStream(mFiel, true);
//                fos.write(allocation.data);
//                fos.close();
...
//                bos = new BufferedOutputStream(new FileOutputStream(mFiel));
//                bos.write(allocation.data);
//                bos.flush();
//                bos.close();

                /**
                 * Using printWriter , BufferedWriter and FileWriter
                 *
                 */

//                PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter(mFiel, true)));
//
//                for (int i = srcOffset; i < srcOffset + toCopy; ++i)
//                    out.write(allocation.data[i]);
//
//                out.close();
//                }
            }
...
//            bos.close();
    ...
    private void readData(long absolutePosition, byte[] target, int length) {
        ...
        // Log getting buffer
        Log.e("readdata l-312 file RSB", target.toString());
    }
