package com.bitvault.launcher.CustomView;
...
public class BlurView extends View {
    ...
    public BlurView(Context context, AttributeSet attrs) {
        ...
        mBlurRadius = a.getDimension(R.styleable.BlurView_realtimeBlurRadius,
        ...
        mOverlayColor = a.getColor(R.styleable.BlurView_realtimeOverlayColor, 0xddeaebec);
        a.recycle();
    }
